...
注意：
    在提交请求的时候，get请求方法不会存在中文乱码问题
    使用post方式提交请求会存在中文乱码问题，我们此时不在方法中一个一个处理
    我们使用一个 过滤器 来统一处理乱码问题

过滤器可以自定义，也可以使用框架中提供好的 CharacterEncodingFilter 是由spring-web提供给的
springmvc jar包中包含 spring-web jar
